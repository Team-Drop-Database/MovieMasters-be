...
```
cd existing_repo
git remote add origin https://gitlab.fdmci.hva.nl/se-specialization-2024-1/projects-tse3/drop-database/backend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.fdmci.hva.nl/se-specialization-2024-1/projects-tse3/drop-database/backend/-/settings/integrations)
