...
public class FriendshipControllerTest {
    ...
    void addFriendSuccessfully() throws UserNotFoundException, FriendshipAlreadyExistsException, UserCannotFriendThemself {
        // Arrange
        FriendshipDto friendshipDto = new FriendshipDto(mockUser1.getUserId(), mockUser2.getUsername(), null,
    ...
    void updateFriendshipStatusSuccessfully() throws UserNotFoundException, FriendshipNotFoundException {
        // Arrange
        FriendshipDto updatedFriendshipDto = new FriendshipDto(mockUser1.getUserId(), mockUser2.getUsername(), null,
    ...
    void getFriendsByStatusSuccessfully() {
        ...
        List<FriendshipDto> friends = List.of(
                new FriendshipDto(1L, mockUser2.getUsername(), null, FriendshipStatus.ACCEPTED, LocalDateTime.now()),
                new FriendshipDto(2L, mockUser3.getUsername(), null, FriendshipStatus.ACCEPTED, LocalDateTime.now())
        );
        when(jwtUtil.getUserId(jwtTokenUser1.replace("Bearer ", ""))).thenReturn(mockUser1.getUserId());
